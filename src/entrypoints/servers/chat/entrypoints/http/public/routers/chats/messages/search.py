...
from src.entrypoints.servers.chat.application.usecases.chats.messages.search import Usecase
from src.entrypoints.servers.chat.entrypoints.http.public.deps.chats.messages.search import dependency
from src.entrypoints.servers.chat.entrypoints.http.public.schemas.chat import Messages
from src.entrypoints.servers.chat.entrypoints.http.public.schemas.chat import SearchMessages
...
async def query(
    ...
    messages, more, prev, next = await usecase.execute(**data)
