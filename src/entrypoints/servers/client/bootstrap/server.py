...
from src.entrypoints.servers.client.entrypoints import router as websockets
from src.entrypoints.servers.client.entrypoints.workers import workers
...
async def lifespan(_app: FastAPI) -> typing.Any:
    ...
    yield
    logger.info("Client application shutdown")
    background.shutdown()
